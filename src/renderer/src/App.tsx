...
import { checkToken } from './utils/client'
import Subjects from './scenes/dashboard/Subjects'
import Students from './scenes/dashboard/Students'
import Profile from './scenes/auth/Profile'
import Course from './scenes/dashboard/Course'
